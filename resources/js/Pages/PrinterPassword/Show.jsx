      ...
      <Modal.Body>
        <div className="space-y-6">
          {/* <div className="flex justify-center">
            <img src={user.profile_path} alt={`${user.dept}'s profile`} className="mt-3 size-2/4" />
          </div> */}
          <div className="flex justify-around">
            <div className="rounded p-3 w-full">
              ...
              <p className="text-base leading-relaxed text-gray-500 dark:text-gray-400"><strong>Username:</strong> {user.dept}</p>
