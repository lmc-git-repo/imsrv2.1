...
export default function Index({
    ...
    const openEditModal = (l2switch) => {
        setSelectedEdit(l2switch);
    ...
    const sortChanged = (name) => {
        ...
        router.get(route('l2sw.index'), queryParams, { preserveScroll: true });
    };

    const deleteL2Switch = (l2switch) => {
        if (!window.confirm('Are you sure you want to delete this L2 Switch?')) {
            return;
        }
                ...
                <div className="max-w-8xl mx-auto sm:px-6 lg:px-8">
                    {success && (
                        <div id="alert-border-3" className="flex items-center p-4 mb-4 text-green-800 border-t-4 border-green-300 bg-green-50 dark:text-green-400 dark:bg-slate-800 dark:border-green-800" role="alert">
                            ...
                            <button onClick={() => router.get(route('l2sw.index'))} type="button" className="ms-auto -mx-1.5 -my-1.5 bg-green-50 text-green-500 rounded-lg focus:ring-2 focus:ring-green-400 p-1.5 hover:bg-green-200 inline-flex items-center justify-center h-8 w-8 dark:bg-slate-800 dark:text-green-400 dark:hover:bg-gray-700" data-dismiss-target="#alert-border-3" aria-label="Close">
                        ...
                        <div className="p-6 text-gray-900 dark:text-gray-100">
                            <div className="overflow-auto">
                                <div className="flex justify-between items-center py-2">
                                    <div>
                                        <label htmlFor="l2switch-search" className="sr-only">
                                            Search L2 Switches
                                        </label>
                                        <TextInput
                                            id="l2switch-search"
                                            name="l2switch-search"
                                            className="w-full"
