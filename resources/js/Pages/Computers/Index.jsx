...
export default function Index({
  ...
  // initialize local filters from incoming queryParams
  const initialFilters = {
    search: queryParams.search || '',
    comp_status: queryParams.comp_status || '',
    comp_storage: queryParams.comp_storage || '',
    asset_class: queryParams.asset_class || '',
    comp_type: queryParams.comp_type || '',
    comp_gen: queryParams.comp_gen || '',
    department_comp: queryParams.department_comp || '',
    comp_os: queryParams.comp_os || '',
  ...
  // keep ref in sync for debounced handler
  useEffect(() => { filtersRef.current = filters }, [filters])

  // sync filters when parent queryParams change (e.g. pagination navigation)
  useEffect(() => {
    setFilters({
      search: queryParams.search || '',
      comp_status: queryParams.comp_status || '',
  ...
  }, [queryParams.search, queryParams.comp_status, queryParams.comp_storage, queryParams.asset_class, queryParams.comp_type, queryParams.comp_gen, queryParams.department_comp, queryParams.comp_os, queryParams.sort_field, queryParams.sort_direction])
  ...
  // debounced search (uses ref to access latest filters)
  ...
  // unified update + navigation helper
  ...
  const handleSearchChange = (value) => {
    // update UI immediately, but use debounced navigation
  ...
  const handleSelectChange = (name, value) => {
    ...
    const next = { ...filters, [name]: filteredValue }
            ...
            <div className="p-6 text-gray-900 dark:text-gray-100">
              ...
              <Pagination
                ...
                queryParams={{
                  ...
                  comp_storage: filters.comp_storage,
                  asset_class: filters.asset_class,
                  comp_type: filters.comp_type,
                  comp_gen: filters.comp_gen,
                  department_comp: filters.department_comp,
                  comp_os: filters.comp_os,
                  sort_field: filters.sort_field,
                  sort_direction: filters.sort_direction
                }}
              />
