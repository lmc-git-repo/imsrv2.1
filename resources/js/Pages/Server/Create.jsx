...
const CreateServer = forwardRef(function CreateServer({ show, onClose }, ref) {
  ...
  if (!show) return null;
    ...
    const onSubmit = (e) => {
      ...
      // submit form (do not log sensitive data)
      post(route('server.store'), {
        preserveScroll: true,
        onSuccess: () => {
          reset();
          if (typeof onClose === 'function') onClose(); // close modal on success
        },
        onError: () => {
          // generic error only — no item details
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Body */}
        <div className="p-6">
          <form onSubmit={onSubmit} className="space-y-4" name="create-server-form">
            {/* Device Name */}
            <div>
...
CreateServer.displayName = 'CreateServer';
