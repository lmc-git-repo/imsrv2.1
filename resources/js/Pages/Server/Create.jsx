        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50 p-4">
            <div className="bg-slate-700 rounded-lg shadow-xl w-full max-w-md max-h-[90vh] overflow-y-auto">
                ...
                <div className="flex justify-between items-center p-4 sm:p-6 border-b border-slate-600">
                    <h2 className="text-lg sm:text-xl font-semibold text-white">Add New Server</h2>
                    <button
                        onClick={onClose}
                ...
                {/* Body */}
                <div className="p-6">
                    <form onSubmit={onSubmit} className="space-y-4" id="create-server-form" name="create-server-form">
                        <div>
