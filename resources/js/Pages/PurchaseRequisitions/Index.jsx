                                        ...
                                        {loading ? (
                                            <tr className="text-center">
                                                ...
                                                purchase_requisitions.data.map(pr => (
                                                    <tr className="bg-white border-b dark:bg-slate-800 dark:border-gray-700 cursor-pointer" key={pr.pr_id} onClick={() => router.visit(route('purchase_requisitions.show', pr.pr_id))}>
                                                        <td className="px-3 py-2">{pr.pr_id}</td>
                                                        <th className="px-3 py-2">{pr.control_num}</th>
                                                        ...
                                                        <td className="px-3 py-2 text-right text-nowrap">
                                                            ...
                                                            <button
                                                                ...
                                                                onClick={(e) => { e.stopPropagation(); openModal(pr, e); }}
                                                            >
                                                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
                                                            ...
                                                            <button 
                                                                onClick={(e) => { e.stopPropagation(); deletePR(pr); }}
