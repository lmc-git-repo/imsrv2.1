...
const CreateModalComponent = ({ show, onClose, departmentsList, mntrUsersList, compNameList }) => {
    if (!show) return null;
            ...
            <Modal.Body className=''>
                <form action="" onSubmit={onSubmit}>
                    <div className="space-y-6">
                        ...
                        <div>
                            <div className="mb-2 block">
                                <Label htmlFor="mntr_user" value="Choose User" />
                            </div>
                            <SelectInput 
                                name='mntr_user'
                                id="mntr_user" 
                        ...
                        {/* <div>
                            <div className="mb-2 block">
                                <Label htmlFor="mntr_asset" value="Enter Computer Asset" />
                            </div>
                            <TextInput 
                                id="mntr_asset" 
                                type="text"
