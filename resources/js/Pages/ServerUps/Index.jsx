    ...
    >
        ...
        <div className="py-12">
                                                        ...
                                                        <td className="px-3 py-2 text-right text-nowrap">
                                                            ...
                                                            {(auth.user.role === 'super admin' || auth.user.role === 'admin') && (
                                                                <button
                                                                    ...
                                                                    onClick={(e) => { e.stopPropagation(); openEditModal(serverups); }}
                                                                >
                                                            ...
                                                            {(auth.user.role === 'super admin' || auth.user.role === 'admin') && (
                                                                <button 
                                                                    onClick={(e) => { e.stopPropagation(); deleteComputers(serverups); }}
                                                            ...
                                                            <button 
                                                                ...
                                                                onClick={(e) => { e.stopPropagation(); handlePrint(serverups); }}
                                                            >
                                                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
            ...
            <EditModalComponent
                ...
                selectedEditServerUps={selectedEdit}
                generations={generations}
             />
